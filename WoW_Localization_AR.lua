...
QTR_Messages = {
   ...
   itemchoose1       = "ﺳﺘﺘﻤﻜﻦ ﻣﻦ إﺧﺘﻴﺎر إﺣﺪى ﻫﺬﻩ اﻟﻤﻜﺎﻓﺌﺎت:", -- Możesz wybrać jedną z nagród: (You will be able to choose one of these rewards:)
...
local p_race_arabic = {
   ["Blood Elf"] = { M="بلود الف", F="بلود الفة" },
   ["Dark Iron Dwarf"] = { M="دارك ايرون دوارف", F="دارك ايرون دوارفة" },
   ["Dracthyr"] = { M="دراكثير", F="دراكثيرة" },
   ["Draenei"] = { M="درايني", F="دراينية" },
   ["Dwarf"] = { M="دوارف", F="دوارفة" },
   ["Gnome"] = { M="جنوم", F="جنومة" },
   ["Goblin"] = { M="جوبلن", F="جوبلنة" },
   ["Highmountain Tauren"] = { M="هاي ماونتن تورين", F="هاي ماونتن تورينة" },
   ["Human"] = { M="هيومن", F="هيومنة" },
   ["Kul Tiran"] = { M="كول تيران", F="كول تيرانة" },
   ["Lightforged Draenei"] = { M="لايت فورجد درايني", F="لايت فورجد دراينية" },
   ["Mag'har Orc"] = { M="ماج هار اورك", F="ماج هار اوركة" },
   ["Mechagnome"] = { M="ميكاجنوم", F="ميكاجنومة" },
   ["Nightborne"] = { M="نايت بورن", F="نايت بورنة" },
   ["Night Elf"] = { M="نايت الف", F="نايت الفة" },
   ["Orc"] = { M="اورك", F="اوركة" },
   ["Pandaren"] = { M="بانداران", F="باندارانة" },
   ["Tauren"] = { M="تورين", F="تورينة" },
   ["Troll"] = { M="ترول", F="ترولة" },
   ["Undead"] = { M="اندد", F="اندية" },
   ["Void Elf"] = { M="فويد الف", F="فويد الفة" },
   ["Vulpera"] = { M="فولبيرا", F="فولبيرا" },
   ["Worgen"] = { M="وارجين", F="وارجينة" },
   ["Zandalari Troll"] = { M="زاندالاري ترول", F="زاندالاري ترولة" },
};
local p_class_arabic = {
   ["Death Knight"] = { M="ديث نايت", F="ديث نايتة" },
   ["Demon Hunter"] = { M="ديمون هانتر", F="ديمون هانترة" },
   ["Druid"] = { M="درويد", F="درويدة" },
   ["Evoker"] = { M="ايفوكر", F="ايفوكرة" },
   ["Hunter"] = { M="هانتر", F="هانترة" },
   ["Mage"] = { M="ميج", F="ميجة" },
   ["Monk"] = { M="مونك", F="مونكة" },
   ["Paladin"] = { M="بالادين", F="بالادينة" },
   ["Priest"] = { M="بريست", F="بريستة" },
   ["Rogue"] = { M="روق", F="روقة" },
   ["Shaman"] = { M="شامان", F="شامانة" },
   ["Warlock"] = { M="وارلوك", F="وارلوكة" },
   ["Warrior"] = { M="واريور", F="واريورة" },
};
...
if (p_race[QTR_race]) then
   if (WoWTR_Localization.lang == 'AR') then
      ...
      --player_race_table = { M=p_race_arabic[QTR_race].M, F=p_race_arabic[QTR_race].F };
   else
      player_race_table = { M1=p_race[QTR_race].M1, D1=p_race[QTR_race].D1, C1=p_race[QTR_race].C1, B1=p_race[QTR_race].B1, N1=p_race[QTR_race].N1, K1=p_race[QTR_race].K1, W1=p_race[QTR_race].W1, M2=p_race[QTR_race].M2, D2=p_race[QTR_race].D2, C2=p_race[QTR_race].C2, B2=p_race[QTR_race].B2, N2=p_race[QTR_race].N2, K2=p_race[QTR_race].K2, W2=p_race[QTR_race].W2 };
   end
else   
...
if (p_class[QTR_class]) then
   if (WoWTR_Localization.lang == 'AR') then
      ...
      --player_class_table = { M=p_class_arabic[QTR_class].M, F=p_class_arabic[QTR_class].F };
   else
      player_class_table = { M1=p_class[QTR_class].M1, D1=p_class[QTR_class].D1, C1=p_class[QTR_class].C1, B1=p_class[QTR_class].B1, N1=p_class[QTR_class].N1, K1=p_class[QTR_class].K1, W1=p_class[QTR_class].W1, M2=p_class[QTR_class].M2, D2=p_class[QTR_class].D2, C2=p_class[QTR_class].C2, B2=p_class[QTR_class].B2, N2=p_class[QTR_class].N2, K2=p_class[QTR_class].K2, W2=p_class[QTR_class].W2 };
   end
else
