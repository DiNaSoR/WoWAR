...
WoWTR_Localization = {
   ...
   optionTitleAR = "ﻣﻠﺤﻖ WOW ﺑﺎﻟﻠﻐﺔ ﺍﻟﻌﺮﺑﻴﺔ، baranogarD & enitalP، )C( 4202-3202",  -- Main title of addon in Arabic
...
WoWTR_Config_Interface = {
   ...
   translateOwnNames = "*cok* مرحبا *نه*",
